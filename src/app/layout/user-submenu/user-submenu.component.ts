    ...
    <div class="relative" #menuContainer>
      ...
      >
        <div class="flex flex-nowrap gap-2 justify-start items-center min-w-0">
          <div class="size-9 rounded-full shadow overflow-hidden shrink-0 bg-slate-200 dark:bg-slate-700 ring-2 ring-white/20">
      ...
      <!-- Dropdown -->
      @if (isOpen()) {
        <div class="absolute top-full right-0 mt-2 w-64 bg-white dark:bg-slate-800 rounded-2xl shadow-2xl border border-slate-100 dark:border-slate-700 overflow-hidden z-200 animate-in fade-in zoom-in-95 duration-150 origin-top-right">

          <!-- User info header -->
          <div class="px-4 py-3.5 bg-slate-50 dark:bg-slate-900/50 border-b border-slate-100 dark:border-slate-700 flex items-center gap-3">
            ...
            <div class="min-w-0 flex-1">
              ...
              <p class="text-xs text-slate-400 dark:text-slate-500 truncate">{{ email() }}</p>
              <p class="text-[10px] font-semibold text-primary uppercase tracking-wide mt-0.5">{{ role() }}</p>
            </div>
          </div>
          ...
          <ul class="flex flex-col py-1.5">
            <li>
              <a
                ...
                class="flex items-center gap-3 px-4 py-2.5 text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors cursor-pointer"
              >
                <div class="flex items-center justify-center size-8 rounded-lg bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 shrink-0">
            ...
            <li>
              <a
                ...
                class="flex items-center gap-3 px-4 py-2.5 text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors cursor-pointer"
              >
                <div class="flex items-center justify-center size-8 rounded-lg bg-slate-100 dark:bg-slate-700/50 text-slate-600 dark:text-slate-400 shrink-0">
          ...
          <div class="border-t border-slate-100 dark:border-slate-700 py-1.5">
            <button
              class="w-full flex items-center gap-3 px-4 py-2.5 text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors cursor-pointer text-left"
              (click)="handleLogoutClick()"
            >
              <div class="flex items-center justify-center size-8 rounded-lg bg-red-50 dark:bg-red-900/30 text-red-500 shrink-0">
